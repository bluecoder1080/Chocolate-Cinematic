...
export default function ProductTextOverlays({
  ...
  return (
    <div
      ref={containerRef}
      className="relative h-[400vh] sm:h-[450vh] md:h-[500vh] pointer-events-none"
    >
        ...
        <div className="relative w-full h-full max-w-7xl mx-auto px-4 sm:px-6 md:px-12 flex items-center justify-center">
          ...
          >
            <div className="backdrop-blur-md bg-gradient-to-t from-black/70 via-black/50 to-transparent p-4 sm:p-6 md:p-8 rounded-lg sm:rounded-xl border border-white/10 max-w-3xl w-full">
              <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-2 sm:mb-3 tracking-tight">
                {product.name}
              </h1>
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-white/95 font-light tracking-wide mb-3 sm:mb-4">
                {product.subtitle}
              </p>
          ...
          <motion.div
            ...
            className="absolute top-16 sm:top-20 left-3 sm:left-6 md:left-12 right-3 sm:right-6 md:right-auto max-w-2xl"
          >
            <div className="backdrop-blur-lg bg-gradient-to-r from-black/75 via-black/60 to-transparent p-4 sm:p-5 md:p-7 rounded-lg sm:rounded-xl border border-white/20">
              <h2 className="text-xl sm:text-2xl md:text-4xl font-bold text-white mb-2 sm:mb-3">
                The Story
              </h2>
              <p className="text-xs sm:text-sm md:text-lg text-white/95 leading-relaxed">
                {product.description}
              </p>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="absolute inset-x-0 bottom-12 sm:bottom-16 px-3 sm:px-6 md:px-12"
          >
            <div className="max-w-5xl mx-auto">
              <h2 className="text-xl sm:text-3xl md:text-5xl font-bold text-white mb-4 sm:mb-8 text-center backdrop-blur-sm bg-black/30 py-3 sm:py-4 rounded-lg sm:rounded-xl px-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 sm:gap-4">
                {product.features.map((feature: string, index: number) => (
                  <motion.div
                    ...
                    className="bg-gradient-to-br from-white/15 via-white/10 to-white/5 backdrop-blur-md p-3 sm:p-5 rounded-lg sm:rounded-xl border border-white/10 hover:border-white/30 transition-all"
                  >
                    <div className="text-xl sm:text-2xl md:text-3xl mb-2 sm:mb-3 text-yellow-400">
                      ✦
                    </div>
                    <div className="text-sm sm:text-lg md:text-xl text-white font-medium">
                      {feature}
                    </div>
                  </motion.div>
                ))}
