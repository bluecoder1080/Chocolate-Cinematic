    ...
    <main className="min-h-screen pt-16">
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <section className="py-20 md:py-32 px-6 md:px-12 bg-black/20">
            <div className="max-w-6xl mx-auto text-center">
              ...
              >
                <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 md:p-12 border border-white/20">
                  ...
                  <div className="text-white/60 mb-8">Per 100g Premium Bar</div>
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="px-12 py-4 bg-gradient-to-r from-yellow-400 to-yellow-600 text-black font-bold text-lg rounded-full glow-hover"
                  >
                    Buy Now
                  </motion.button>
                </div>
            ...
            <section className="py-20 md:py-32 px-6 md:px-12">
              ...
              >
                ...
                <motion.button
                  ...
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="px-10 py-4 bg-white/20 backdrop-blur-md text-white font-semibold text-lg rounded-full border border-white/30 hover:bg-white/30 transition-all"
                >
                  Next Flavor →
                </motion.button>
              </motion.div>
      ...
      {/* Navigation Arrows */}
      <div className="fixed left-4 md:left-8 top-1/2 -translate-y-1/2 z-40">
        <motion.button
          onClick={handlePrevious}
          whileHover={{ scale: 1.1, x: -5 }}
          whileTap={{ scale: 0.9 }}
          className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center text-white text-2xl hover:bg-white/20 transition-all"
      ...
      <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-40">
        <div className="flex gap-3 bg-black/40 backdrop-blur-lg rounded-full p-2 border border-white/20">
